    ...
    public void SetMove(uint piece)
    {
        ...
        if (pte.pieceProperty != 0 || pte.piecePropertyB != 0)
        {
            ...
            while (propertiesA != 0)
            {
                ...
                {
                    pieceInfoText.text += Piece.GetPropertyDescription((Piece.PieceProperty)(1uL << index), pte.type) + "\n\n";
                }
            }
            while (propertiesB != 0)
            {
                ...
                {
                    pieceInfoText.text += Piece.GetPropertyDescription((Piece.PiecePropertyB)(1uL << index), pte.type) + "\n\n";
                }
            }
        }
