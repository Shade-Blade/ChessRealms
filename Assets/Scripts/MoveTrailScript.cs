...
public class MoveTrailScript : MonoBehaviour
{
    ...
    {
        lr.startColor = new Color(0.5f + (lr.startColor.r / 2), 0.5f + (lr.startColor.g / 2), 0.5f + (lr.startColor.b / 2), 0.5f);
        lr.endColor = new Color(0.5f + (lr.endColor.r / 2), 0.5f + (lr.endColor.g / 2), 0.5f + (lr.endColor.b / 2), 0.8f);
    }
    public void SetColorDark()
    {
        lr.startColor = new Color((lr.startColor.r / 2), (lr.startColor.g / 2), (lr.startColor.b / 2), 0.5f);
        lr.endColor = new Color((lr.endColor.r / 2), (lr.endColor.g / 2), (lr.endColor.b / 2), 0.8f);
    }
